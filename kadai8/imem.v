...
module imem(input [5:0] pc, output logic [15:0] o);
	always_comb
		case(pc)
		// synopsys full_case parallel_case
			6'h00:o = 16'b1000_0001_0000_0011; //LI rw,(s)im (rw= 0) lidx= THU, r0<- 3
            6'h01:o = 16'b1000_0101_0000_0000; //LI rw,(s)im (rw= 1) lidx= THU,r1<-0
            6'h02:o = 16'b1000_1001_0000_0010; //LI rw,(s)im (rw= 2) lidx= THU, r2<-2
            6'h03:o = 16'b0100_1000_0000_0000; //SM [(s)im]= 16'd0 *MM nn, mem[0]<-3
            6'h04:o = 16'b0100_1001_0000_0001; //SM [(s)im]= 16'd1 *MM nn, mem[1]<-r1
			...
			6'h0b:o = 16'b0001_1000_0001_0010; //CMP ra,rb, r0, r2
            6'h0c:o = 16'b0101_1101_0000_0111; //JP/BR fp [PC + (s)im],

            6'h0d:o = 16'b0010_0000_0000_0001; // CAL rw=ra,im, r0=r0+1
            6'h0e:o = 16'b0100_1001_0001_0001; //SM [(s)im]= 16'd17 *MM nn, mem[17]=r0
            6'h0f:o = 16'b0000_1010_0010_0011; //CAL rw=brad, r2=r3
            6'h10:o = 16'b1010_0001_1111_1110; // LM rw=[ra + (s)im], r1 <-mem[r0-2]
            6'h11:o = 16'b1010_0000_1111_1101; //LM rw=[ra + (s)im], r0 <-mem[r0-3]
            6'h12:o = 16'b0100_1100_1111_0111; //JP/BR fp [PC + (s)im]
            6'h13:o = 16'b0000_0000_0000_0001; //HALT*/
		endcase
endmodule
